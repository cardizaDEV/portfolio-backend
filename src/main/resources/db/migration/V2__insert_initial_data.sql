...
SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'ActiveMQ' AND c.name = 'Backend')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Angular' AND c.name = 'Frontend')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'ArgoCD' AND c.name = 'Infrastructure')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'AWS' AND c.name = 'Infrastructure')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Caffeine Cache' AND c.name = 'Backend')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'CSS' AND c.name = 'Frontend')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'CSS' AND c.name = 'Styles')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'D3.js' AND c.name = 'Frontend')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Dart' AND c.name = 'Frontend')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Docker' AND c.name = 'Infrastructure')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'PostgreSQL' AND c.name = 'Base de datos')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Figma' AND c.name = 'Tools')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Figma' AND c.name = 'Styles')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Firebase' AND c.name = 'Base de datos')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Flutter' AND c.name = 'Frontend')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Flyway'  AND c.name = 'Base de datos')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Git' AND c.name = 'Tools')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'GitHub Actions' AND c.name = 'Infrastructure')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Gradle' AND c.name = 'Utilities')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Grafana' AND c.name = 'Infrastructure')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'HTML' AND c.name = 'Frontend')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Java' AND c.name = 'Backend')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'JasperReports' AND c.name = 'Backend')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Jenkins' AND c.name = 'Infrastructure')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Jira' AND c.name = 'Tools')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'JPA' AND c.name = 'Backend')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'JUnit' AND c.name = 'Styles')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Keycloak' AND c.name = 'Backend')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Kotlin' AND c.name = 'Backend')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Liquibase' AND c.name = 'Base de datos')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Lombok' AND c.name = 'Backend')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'MapStruct' AND c.name = 'Backend')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Maven' AND c.name = 'Utilities')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Mockito' AND c.name = 'Styles')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'MongoDB' AND c.name = 'Base de datos')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'MySQL' AND c.name = 'Base de datos')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Node.js' AND c.name = 'Backend')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'npm' AND c.name = 'Utilities')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Ontimize Boot' AND c.name = 'Backend')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Ontimize Web' AND c.name = 'Frontend')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'OpenAPI (Swagger)' AND c.name = 'Backend')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'PostgreSQL: Multi-Tenancy' AND c.name = 'Base de datos')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Postman' AND c.name = 'Tools')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'S3' AND c.name = 'Infrastructure')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'SCSS' AND c.name = 'Frontend')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'SCSS' AND c.name = 'Styles')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Spring Boot' AND c.name = 'Backend')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Spring Security' AND c.name = 'Backend')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'Springfox (Swagger)' AND c.name = 'Backend')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'T-SQL' AND c.name = 'Base de datos')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'TailwindCSS' AND c.name = 'Frontend')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'TailwindCSS' AND c.name = 'Styles')
UNION ALL SELECT t.id, c.id FROM technology t, technology_category c
WHERE (t.name = 'TypeScript' AND c.name = 'Frontend');
...
WHERE e.title = 'FULL STACK DEVELOPER - 2' AND t.name IN (
    'Java', 'HTML', 'SCSS', 'TypeScript', 'Spring Boot', 'JPA', 'MapStruct', 'MySQL', 'MongoDB', 'Angular', 'Git',
...
WHERE e.title = 'BOOTCAMP FULL STACK DEVELOPER' AND t.name IN (
    'Java', 'HTML', 'SCSS', 'TypeScript', 'Spring Boot', 'PostgreSQL', 'Liquibase', 'Git', 'Jira', 'Ontimize Web',
